...
if whichplots(3)
    ...
    hf = figure('Units','centimeters','Position',[2,1,Ns * 7, min(Nv * 3.5, 27)], 'Color', 'w');
    % Mengunci proporsi ekspor PDF agar persis seperti di layar (A4)
    set(hf, 'PaperUnits', 'centimeters');
    set(hf, 'PaperType', 'A4');
    set(hf, 'PaperPositionMode', 'manual');
    set(hf, 'PaperPosition', [1 1 Ns*7 min(Nv * 3.5, 27)]);
    % -----------------------------------
    for iv = 1:Nv
        v = varstoplot(iv);
